...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-MSI -Action Install -Path "$dirFiles\ArcGISPro.msi" -Parameters 'ALLUSERS=1 ESRI_LICENSE_HOST=27004@VMWAS22.MSUDENVER.EDU SOFTWARE_CLASS=Professional AUTHORIZATION_TYPE=CONCURRENT_USE INSTALLDIR="C:\MyArcGISPro\" ENABLEEUEI=0 /qn' -PassThru
